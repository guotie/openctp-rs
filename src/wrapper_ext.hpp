// generated by python autobind.py @2023-08-10
#include "wrapper.hpp"
...
int Rust_CThostFtdcMdApi::ReqQryMulticastInstrument(CThostFtdcQryMulticastInstrumentField *pQryMulticastInstrument, int nRequestID) { return m_inner->ReqQryMulticastInstrument(pQryMulticastInstrument, nRequestID); }
...
int Rust_CThostFtdcTraderApi::ReqUserLogin(CThostFtdcReqUserLoginField *pReqUserLoginField, int nRequestID, TThostFtdcSystemInfoLenType length, TThostFtdcClientSystemInfoType systemInfo) { return m_inner->ReqUserLogin(pReqUserLoginField, nRequestID, length, systemInfo); }
...
int Rust_CThostFtdcTraderApi::ReqQryMaxOrderVolume(CThostFtdcQryMaxOrderVolumeField *pQryMaxOrderVolume, int nRequestID) { return m_inner->ReqQryMaxOrderVolume(pQryMaxOrderVolume, nRequestID); }
...
int Rust_CThostFtdcTraderApi::ReqQryTraderOffer(CThostFtdcQryTraderOfferField *pQryTraderOffer, int nRequestID) { return m_inner->ReqQryTraderOffer(pQryTraderOffer, nRequestID); }
...
int Rust_CThostFtdcTraderApi::ReqQryClassifiedInstrument(CThostFtdcQryClassifiedInstrumentField *pQryClassifiedInstrument, int nRequestID) { return m_inner->ReqQryClassifiedInstrument(pQryClassifiedInstrument, nRequestID); }
int Rust_CThostFtdcTraderApi::ReqQryCombPromotionParam(CThostFtdcQryCombPromotionParamField *pQryCombPromotionParam, int nRequestID) { return m_inner->ReqQryCombPromotionParam(pQryCombPromotionParam, nRequestID); }
int Rust_CThostFtdcTraderApi::ReqQryRiskSettleInvstPosition(CThostFtdcQryRiskSettleInvstPositionField *pQryRiskSettleInvstPosition, int nRequestID) { return m_inner->ReqQryRiskSettleInvstPosition(pQryRiskSettleInvstPosition, nRequestID); }
int Rust_CThostFtdcTraderApi::ReqQryRiskSettleProductStatus(CThostFtdcQryRiskSettleProductStatusField *pQryRiskSettleProductStatus, int nRequestID) { return m_inner->ReqQryRiskSettleProductStatus(pQryRiskSettleProductStatus, nRequestID); }
int Rust_CThostFtdcTraderApi::ReqQrySPBMFutureParameter(CThostFtdcQrySPBMFutureParameterField *pQrySPBMFutureParameter, int nRequestID) { return m_inner->ReqQrySPBMFutureParameter(pQrySPBMFutureParameter, nRequestID); }
int Rust_CThostFtdcTraderApi::ReqQrySPBMOptionParameter(CThostFtdcQrySPBMOptionParameterField *pQrySPBMOptionParameter, int nRequestID) { return m_inner->ReqQrySPBMOptionParameter(pQrySPBMOptionParameter, nRequestID); }
int Rust_CThostFtdcTraderApi::ReqQrySPBMIntraParameter(CThostFtdcQrySPBMIntraParameterField *pQrySPBMIntraParameter, int nRequestID) { return m_inner->ReqQrySPBMIntraParameter(pQrySPBMIntraParameter, nRequestID); }
int Rust_CThostFtdcTraderApi::ReqQrySPBMInterParameter(CThostFtdcQrySPBMInterParameterField *pQrySPBMInterParameter, int nRequestID) { return m_inner->ReqQrySPBMInterParameter(pQrySPBMInterParameter, nRequestID); }
int Rust_CThostFtdcTraderApi::ReqQrySPBMPortfDefinition(CThostFtdcQrySPBMPortfDefinitionField *pQrySPBMPortfDefinition, int nRequestID) { return m_inner->ReqQrySPBMPortfDefinition(pQrySPBMPortfDefinition, nRequestID); }
int Rust_CThostFtdcTraderApi::ReqQrySPBMInvestorPortfDef(CThostFtdcQrySPBMInvestorPortfDefField *pQrySPBMInvestorPortfDef, int nRequestID) { return m_inner->ReqQrySPBMInvestorPortfDef(pQrySPBMInvestorPortfDef, nRequestID); }
int Rust_CThostFtdcTraderApi::ReqQryInvestorPortfMarginRatio(CThostFtdcQryInvestorPortfMarginRatioField *pQryInvestorPortfMarginRatio, int nRequestID) { return m_inner->ReqQryInvestorPortfMarginRatio(pQryInvestorPortfMarginRatio, nRequestID); }
int Rust_CThostFtdcTraderApi::ReqQryInvestorProdSPBMDetail(CThostFtdcQryInvestorProdSPBMDetailField *pQryInvestorProdSPBMDetail, int nRequestID) { return m_inner->ReqQryInvestorProdSPBMDetail(pQryInvestorProdSPBMDetail, nRequestID); }
